...
class Aula(models.Model):
	aula_id = models.CharField(max_length=10,unique=True)
	tipo_aula = models.CharField(max_length=15 ,choices = (('I','Interna'), ('E','Externa'), ('L','Laboratorio')))
	capacidad = models.PositiveIntegerField()
	estatus_aula = models.CharField(max_length=15, choices = (('A','Activa'), ('I','Inactiva')))
...
class Usuario(models.Model):
	...
	estatus = models.CharField(max_length= 2, choices = (('A','Activo'),('I','Inactivo'),('ED','Emergencia Docente')), default = 'A')
...
class Programacion(models.Model):
	...
	ruta_pdf = models.CharField(max_length=100, blank=True, unique=True, editable=False)
...
class ProgramacionDetalle(models.Model):
	...
	seccion = models.CharField(max_length=45, blank=True)
...
class MateriaSolicitada(models.Model):
	estatus = models.CharField(max_length=3,choices = (('AC','AceptadaCoordinador'),('RC','RechazadaCoordinador'),('RJ','RechazadaJefe'),('P','Procesando'),('AJ','AceptadaJefe'),('PJ','ProcesandoJefe'),('N','No Enviada')),editable=True,default='N')
...
class Notificacion(models.Model):
	...
	estatus = models.CharField(max_length=7,editable=False, blank = True)
